...
console.log(`Tables: properties (${counts.properties}), applications (${counts.applications}), sub_permits (${counts.sub_permits}), fees (${counts.fees}), inspections (${counts.inspections})`);
